(function () {
	...
	var offside = createCommonjsModule(function (module) {
	...
	var glideFocus = new Glide$1('#glide-focus');
	...
	//
	var slidersCat1 = document.querySelectorAll('.glideCat1');

	for (var i = 0; i < slidersCat1.length; i++) {
	  var glideCat1 = new Glide$1(slidersCat1[i]);
	...
	//
	var slidersCat2 = document.querySelectorAll('.glideCat2');

	for (var j = 0; j < slidersCat2.length; j++) {
	  var glideCat2 = new Glide$1(slidersCat2[j]);
